...
<title>Car Details of particular colour</title>
</head>
<body>
...
<sql:query var="rs" dataSource="${db}">select * from parking_details where Colour='<%=request.getParameter("color")%>'</sql:query>

<table id="customers_table" cellspacing="4px">
                <tr id="TableTitle">
                    <td colspan="4">Car Details</td>
                </tr>
                <tr>
